...
| **Programme** | |
| **Date** | YYYY-MM-DD |
| **Tier** | Tier 1 (Weekly) \| Tier 2 (Fortnightly) \| Tier 3 (Monthly) |
| **Facilitator** | |
| **Participants** | |
...
| Escalation | Source | Required outcome |
|------------|--------|-----------------|
| | | Bind \| Escalate further |

---

## Fitness Function Failures

| Function | Failure | Upstream assumption at risk |
|----------|---------|----------------------------|
| | | |

---

## New Questions Since Last Pulse
...
## Pulse Report (complete after session)

| Decisions made | Escalations triggered | Questions deferred | Session produced binding decision? |
|---------------|----------------------|--------------------|-----------------------------------|
| | | | Yes / No |
