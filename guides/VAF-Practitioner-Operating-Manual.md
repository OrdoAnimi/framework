# OrdoAnimi Practitioner Operating Manual

**For architects who need to move faster.**

Version 1.0 — The OrdoAnimi Framework

---

## How to use this manual

This manual covers all 18 OrdoAnimi artefacts. Each entry has three layers:

1. **Extraction guide** — how to run the conversation that produces the artefact
2. **OrdoAnimi template** — what to write, at what resolution
...
**OrdoAnimi time:** 2–4 hours (structured workshop with the right people in the room)
**Time saving:** 85–95%
...
**OrdoAnimi time:** Half-day workshop + 2-hour review
**Time saving:** 80–90%
...
**OrdoAnimi time:** 2-hour facilitated session
**Time saving:** 70–85%
...
**OrdoAnimi time:** 2-hour diagnostic session
**Time saving:** 75–90%
...
**OrdoAnimi time:** 20–30 minutes, immediately after the decision is made
...
**OrdoAnimi time:** 2-hour definition session + implementation time per function
...
**Standard time:** 2–4 weeks
**OrdoAnimi time:** 90-minute facilitated session
**Time saving:** 75–85%
...
**OrdoAnimi time:** 30-minute weekly update
...
**OrdoAnimi time:** 15-minute update per cycle
...
**OrdoAnimi time:** 1-hour initial session, 30-minute fortnightly update
...
**OrdoAnimi time:** 2-hour quarterly session
**Time saving:** 70–80%
...
**OrdoAnimi time:** 30–45 minutes per cycle
...
**OrdoAnimi time:** 30-minute quarterly reflection
...
**OrdoAnimi time:** Half-day to produce
...
**OrdoAnimi time:** Initial catalogue in one 3-hour session; updated as patterns are identified
...
**OrdoAnimi time:** 2 hours to produce per playbook
...
| Artefact | Standard time | OrdoAnimi time | Saving |
|----------|--------------|----------|--------|
