...
The organisations that build what this series has described will not call it OrdoAnimi. They will not call it a framework or a methodology or a transformation. They will describe it as finally being able to see what is happening. Finally being able to make a decision and trust that it will hold. Finally being able to move without rebuilding the same context from scratch every time a new programme starts.
