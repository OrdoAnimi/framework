...
The previous chapter introduced the temporal dimension that all five conditions share — the systematic elimination of any force that would compel ambiguity to end — and described the first structural countermeasure: the design of time as a constraint rather than a passive dimension.
...
The question that Part Two leaves the reader with is this: not what has been designed wrongly, but what would have to be designed differently for the outcomes to be different.
